(function () {
    (function drawHead() {
        ...
        //eyes
        drawElipse(ctx, 55, 180, 8, 0, 2 * Math.PI, false, 1, 0.65);
        drawElipse(ctx, 87, 180, 8, 0, 2 * Math.PI, false, 1, 0.65);

        ctx.fillStyle = "#1F505A";
        drawElipse(ctx, 88, 117, 3.5, 0, 2 * Math.PI, false, 0.60, 1);
        drawElipse(ctx, 142, 117, 3.5, 0, 2 * Math.PI, false, 0.60, 1);
    ...
    (function drawBycicle() {
        var ctx = document.getElementById("bycicle").getContext("2d");
        ctx.strokeStyle = "#1F505A";
        ctx.fillStyle = "#90CAD7";
        ctx.lineWidth = 2;
